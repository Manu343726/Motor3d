...
#Region "Calculo Espacio 3D"
    ...
    Public Function CALC3D_OrientacionCara(ByVal Camara As Camara, ByVal Cara As Cara) As Boolean
...
#Region "Calculo Representaciones"
    ...
    Public Function CALCREP_EstablecerRepresentacion(ByVal Camara As Camara, ByVal TipoRepresentacion As TipoRepresentacion) As Camara
    ...
    Public Function CALCREP_Representacion(ByVal Camara As Camara, ByVal Punto As Punto3D) As Point
    ...
    Public Function CALCREP_RepresentacionConica(ByVal Camara As Camara, ByVal Punto As Punto3D) As Point
        Dim Interseccion As Punto3D

        Interseccion = CALCTRANS3D_TransformarPunto(Punto, Camara.MatrizProyeccion)
        ...
        Return New Point(Interseccion.X, Interseccion.Y)
    End Function
    ...
    Public Function CALCREP_RepresentacionOrtograficaGeneral(ByVal Camara As Camara, ByVal Punto As Punto3D) As Point
        Dim r, s As Double
    ...
    Public Function CALCREP_RepresentacionOrtograficaLibre(ByVal Camara As Camara, ByVal Punto As Punto3D) As Point
        Dim Plano As Plano3D
...
#Region "Calculo Sombreado"
    ...
    Public Function CALCSOM_PoligonoSombra2D(ByVal Poliedro As Poliedro, ByVal Cara As Cara, ByVal Plano As Plano3D, ByVal FocoLuz As Punto3D, ByVal Camara As Camara) As Point()
    ...
    Public Function CALCSOM_IluminacionModeloPhong(ByVal Foco As Foco, ByVal Iluminacion As DatosIluminacion, ByVal Normal As Vector3D, ByVal Punto As Punto3D, ByVal ColorBase As Color, ByVal Camara As Camara) As Color
    ...
    Public Function CALCSOM_IluminacionModeloPhong(ByVal Focos() As Foco, ByVal Iluminacion As DatosIluminacion, ByVal Normal As Vector3D, ByVal Punto As Punto3D, ByVal ColorBase As Color, ByVal Camara As Camara) As Color
        ...
        For i As Long = 0 To Focos.GetUpperBound(0)
            If Focos(i).Tipo = TipoFoco.Puntual OrElse Focos(i).EsVisible(Punto, Normal) Then
    ...
    Public Sub CALCSOM_FlatShading(ByRef MetodoDibujo As Motor3D.PINT_DelPintarPoligonoColor, ByVal Focos() As Foco, ByVal Iluminacion As DatosIluminacion, ByVal CaraBuffer As CaraBuffer, ByVal Cara As Cara, ByVal Camara As Camara)
    ...
    Public Sub CALCSOM_FlatShading(ByRef MetodoDibujo As Motor3D.PINT_DelPintarPoligonoColor, ByVal Focos() As Foco, ByVal Iluminacion As DatosIluminacion, ByVal CaraBuffer As CaraBuffer, ByVal Cara As Cara, ByVal Camara As Camara, ByVal Teselacion As Boolean)
        Dim T(2) As Point
    ...
    Public Sub CALCSOM_WireFrameShading(ByRef MetodoDibujo As Motor3D.PINT_DelDibujarPoligonoColor, ByVal Focos() As Foco, ByVal Iluminacion As DatosIluminacion, ByVal CaraBuffer As CaraBuffer, ByVal Cara As Cara, ByVal Camara As Camara)
        MetodoDibujo.Invoke(Cara.Representacion, CALCSOM_IluminacionModeloPhong(Focos, Iluminacion, Cara.Baricentro.Normal, Cara.Baricentro.Coordenadas, Cara.Color, Camara))
    End Sub

    Public Sub CALCSOM_GouraudShading(ByRef MetodoDibujo As Motor3D.PINT_DelPintarPoligonoColores, ByVal Poliedro As Poliedro, ByVal IndiceCara As Long, ByVal Camara As Camara)
    ...
    Public Sub CALCSOM_GouraudShading(ByRef MetodoDibujo As Motor3D.PINT_DelPintarPoligonoColores, ByVal Poliedro As Poliedro, ByVal IndiceCara As Long, ByVal Camara As Camara, ByVal Teselacion As Boolean)
        Dim ColorVertices(2) As Color
        Dim Vertices(2) As Point
        Dim Triangulo As Triangulo
    ...
    Public Sub CALCSOM_PhongShading(ByVal MetodoDibujo As [Delegate], ByVal Focos() As Foco, ByVal Poliedro As Poliedro, ByVal CaraBuffer As CaraBuffer, ByVal Camara As Camara, ByVal Iluminacion As DatosIluminacion)
        Dim ColorVertices(2) As Color
        Dim Vertices(2) As Point
